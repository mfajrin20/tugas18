...
import 'package:tugas1/Kriteria/KriteriaPivot.dart';


class KriteriaFlank extends StatelessWidget {
  const KriteriaFlank ({Key? key}) : super(key: key);
  @override
                              ...
                              DataTable(
                                ...
                                rows: <DataRow>[
                                  DataRow(cells: <DataCell> [
                                    DataCell(Text('Shooting, Dribble, Agility',
                                      style: TextStyle(
                                        fontSize: 10,
                                        color: Colors.black,
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => KriteriaPivot()));
                            },
