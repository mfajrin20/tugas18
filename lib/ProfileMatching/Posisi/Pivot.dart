  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Pivot",textAlign: TextAlign.justify,),
      ),
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      child: FadeAnimation(1.6, Container(
                        ...
                        child: Center(
                          child: Text("INPUT DATA PIVOT", style: TextStyle(color: Colors.black54, fontSize: 20, fontWeight: FontWeight.bold),),
                        ),
                      )),
                    )
