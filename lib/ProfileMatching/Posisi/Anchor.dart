  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Anchor",textAlign: TextAlign.justify,),
      ),
          ...
          child: Column(
            children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      child: FadeAnimation(1.6, Container(
                        ...
                        child: Center(
                          child: Text("INPUT DATA ANCHOR", style: TextStyle(color: Colors.black54, fontSize: 20, fontWeight: FontWeight.bold),),
                        ),
                      )),
                    )
              ...
              SelectFormField(
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    return 'Passing tidak boleh kosong';
                  }
                  return null;
                },
              ),
