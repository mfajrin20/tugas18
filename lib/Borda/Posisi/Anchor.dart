...
class BordaAnchor extends StatelessWidget {
  const BordaAnchor ({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Hasil Perhitungan Borda Posisi Anchor",textAlign: TextAlign.justify,),
      ),
